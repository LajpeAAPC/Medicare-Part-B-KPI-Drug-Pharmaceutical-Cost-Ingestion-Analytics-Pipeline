...
## 📌 Project Overview
This **KPI Dashboard** project uses an end-to-end data engineering and analytics pipeline using CMS Medicare Part B National Summary data. The analysis focuses specifically on **Non-Chemotherapy Drugs (J-Codes J0000 - J8499)**. 

The data pipeline takes unstructured enterprise spreadsheets, fixes severe data quality anomalies, handles a local relational database migration, and reveals operational expenditure drivers via an interactive executive dashboard.

> 💡 **Key Analytical Insight:** Out of hundreds of specialized medications, a single formulation—**Drug Code J0178**—drives a staggering **$1.76 Billion** in direct federal Medicare payouts, commanding the **highest financial footprint in the entire dataset. Drug Code J0178 refers to “aflibercept (brand name Eylea).** A drug that treats diabetic eye conditions.
...
**Link for EDA & Data Cleaning:** https://github.com/LajpeAAPC/Medicare-Part-B-KPI-Drug-Pharmaceutical-Cost-Ingestion-Analytics-Pipeline/blob/main/EDA%20Cleaning%20KPI%20Drug%202026

Raw healthcare administration files frequently have complex layout barriers that break downstream analytical models. This pipeline implements strict institutional validity controls to clean and reduce **1,420 raw records down to 535 highly audited data rows**:
